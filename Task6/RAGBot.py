...
FEW_SHOT_EXAMPLES = [
    {
        ...
        "context": "Эффект Вейра — феномен квантовой запутанности между особями одного вида на расстоянии до 10 км. Наблюдается у стайных птиц (например, у сереброкрылых ласточек) и косяков рыб.",
        "response": "Эффект Вейра — феномен квантовой запутанности между особями одного вида на расстоянии до 10 км. Наблюдается у стайных птиц (например, у сереброкрылых ласточек) и косяков рыб."
    },
    {
        "query": "Что такое Квантовая биозоология?",
        "context": "Квантовая биозоология — междисциплинарная наука, изучающая проявления квантовой когерентности, запутанности и туннелирования в биологических системах животных. Основана в 2025 году доктором Элиасом Вейром.",
        "response": "Квантовая биозоология — междисциплинарная наука, изучающая проявления квантовой когерентности, запутанности и туннелирования в биологических системах животных. Основана в 2025 году доктором Элиасом Вейром."
    }
]

# Системный промпт с защитой
SYSTEM_PROMPT = """Ты - полезный ассистент с доступом к базе знаний о Квантовой биозоологии.
...
• Что такое Эффект Вейра?
• Что такое квантовое сибиотическое кольцо
"""
